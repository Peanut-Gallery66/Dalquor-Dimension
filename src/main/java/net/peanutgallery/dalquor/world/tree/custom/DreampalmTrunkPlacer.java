...
public class DreampalmTrunkPlacer extends TrunkPlacer {
    public static final Codec<DreampalmTrunkPlacer> CODEC = RecordCodecBuilder.create(objectInstance ->
            fillTrunkPlacerFields(objectInstance).apply(objectInstance, DreampalmTrunkPlacer::new));

    public DreampalmTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
        super(baseHeight, firstRandomHeight, secondRandomHeight);
    }

    @Override
    protected TrunkPlacerType<?> getType() {
        return ModTrunkPlacerTypes.DREAMPALM_TRUNK_PLACER;
    }
