package net.peanutgallery.dalquor.world.tree.custom;
...
public class DreampalmFoliagePlacer extends FoliagePlacer {
    public static final Codec<DreampalmFoliagePlacer> CODEC = RecordCodecBuilder.create(dreampalmFoliagePlacerInstance ->
            fillFoliagePlacerFields(dreampalmFoliagePlacerInstance).and(Codec.intRange(0, 12).fieldOf("height")
                    .forGetter(instance -> instance.height)).apply(dreampalmFoliagePlacerInstance, DreampalmFoliagePlacer::new));
    private final int height;

    public DreampalmFoliagePlacer(IntProvider radius, IntProvider offset, int height) {
        super(radius, offset);
        this.height = height;
    }
    ...
    protected FoliagePlacerType<?> getType() {
        return ModFoliagePlacerTypes.DREAMPALM_FOLIAGE_PLACER;
    }
